 ...
 *     s_hLog = api->logger->Log_GetContext("SPF_MapOrigin");
...
typedef struct SPF_Logger_API {
     ...
     *
     * @param pluginName The unique name of the plugin (e.g., "SPF_MapOrigin"). This should match
     ...
     *                     Example: "SPF_MapOrigin.update.position_log"
