...
*     SPF_Localization_Handle* h = api->localization->Loc_GetContext("SPF_MapOrigin");
*     
*     char buffer[256];
 ...
 *     - `SPF_MapOrigin/localization/en.json`
 *     - `SPF_MapOrigin/localization/uk.json`
 ...
 * these keys in your component's localization files (e.g., `SPF_MapOrigin/localization/en.json`).
 *
 * @b Example:
