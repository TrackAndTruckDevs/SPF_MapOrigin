...
* ================================================================================================
* @code                                                                                           
* void SPF_MapOrigin_OnActivated(const SPF_Core_API* api) {
*     SPF_Environment_Handle* h = api->environment->Env_GetContext("SPF_MapOrigin");
*
...
typedef struct SPF_Environment_API {
     ...
     * @param h The context handle.
     * @param out_buffer Buffer to receive the path (e.g., "spfPlugins/SPF_MapOrigin/").
     * @return Length of the path string.
     */
     ...
     * @param h The context handle.
     * @param out_buffer Buffer to receive the path (e.g., "spfPlugins/SPF_MapOrigin/config/").
     * @return Length of the path string.
     */
     ...
     * @param h The context handle.
     * @param out_buffer Buffer to receive the path (e.g., "spfPlugins/SPF_MapOrigin/localization/").
     * @return Length of the path string.
     */
     ...
     * @param h The context handle.
     * @param out_buffer Buffer to receive the path (e.g., "spfPlugins/SPF_MapOrigin/logs/").
     * @return Length of the path string.
     */
     ...
     * @param h The context handle.
     * @param out_buffer Buffer to receive the path (e.g., "spfPlugins/SPF_MapOrigin/data/").
     * @return Length of the path string.
     */
