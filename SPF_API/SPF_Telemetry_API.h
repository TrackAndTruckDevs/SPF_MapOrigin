...
*     SPF_Telemetry_Handle* h = api->telemetry->Tel_GetContext("SPF_MapOrigin");
*     
 ...
 *     handle via `GetContext("SPF_MapOriginName")`. This handle will manage all subsequent subscriptions.
 *
 ...
 *     g_my_context.telemetry_handle = g_my_context.telemetry_api->GetContext("SPF_MapOrigin");
 *
